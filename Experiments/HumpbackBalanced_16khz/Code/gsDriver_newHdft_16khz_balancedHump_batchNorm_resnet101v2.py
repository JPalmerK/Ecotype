...
model_save_path = f'MnBalanced_16khz_Resnet101_{timestamp}.keras'
...
history_save_path = f"training_history_resnet101{timestamp}.json"
...
metadata_save_path = f"metadata_resnet101{timestamp}.json"
...
conf_matrix_save_path = f'ConfMat_resnet101{timestamp}.csv'
