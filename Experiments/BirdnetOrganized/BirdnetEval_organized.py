...
if __name__ == "__main__":
    ...
    try:
        eval_dclde_birdnet_01 = pd.read_csv('C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\BirdnetOrganized\Birdnet02_DCLDE_eval.csv')
    except:
            # Process all DCLDE datasets into one DataFrame.
            eval_dclde_birdnet_01 = process_multiple_datasets(
                model_config_01["model_path"],
            ...
            eval_dclde_birdnet_01.to_csv('C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\BirdnetOrganized\Birdnet02_DCLDE_eval.csv', index=False)
    
    
    
    try:
        eval_malahat_birdnet_01 = pd.read_csv('C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\\BirdnetOrganized\Birdnet02_Malahat_eval.csv')
    ...
    try:
        eval_dclde_birdnet_03 = pd.read_csv('C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\BirdnetOrganized\Birdnet02_DCLDE_eval.csv')
    except:
            # Process all DCLDE datasets into one DataFrame.
            ...
            eval_dclde_birdnet_03.to_csv('C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\BirdnetOrganized\Birdnet02_DCLDE_eval.csv', index=False)
    
    
    
    try:
        eval_malahat_birdnet_03 = pd.read_csv('C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\\BirdnetOrganized\Birdnet02_Malahat_eval.csv')
        ...
        eval_malahat_birdnet_03 = process_multiple_datasets(
            ...
            output_csv='C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\\BirdnetOrganized\\Birdnet02_Malahat_eval.csv', 
            classes=['SRKW','HW','TKW'])  
        eval_malahat_birdnet_03.to_csv('C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\\BirdnetOrganized\\Birdnet02_Malahat_eval.csv', index=False)
    ...
    # Evaluate and plot DCLDE performance
    metrics_DCLDE_02 = evaluate_model(eval_dclde_birdnet_03, 
                                      custom_thresholds=custom_thresholds_dclde, 
                                pr_title="DCLDE Precision–Recall Curve 02", 
                                roc_title="DCLDE ROC Curve 02")
    ...
    # Evaluate and plot Malahat performance
    metrics_malahat_02 = evaluate_model(eval_malahat_birdnet_03, 
                                        custom_thresholds=custom_thresholds_dclde, 
                                  pr_title="Malahat Precision–Recall Curve 02",
                                  roc_title="Malahat ROC Curve 02")