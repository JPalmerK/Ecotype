# Birdnet 11: exactly birdnet 10 (as below) uses 400 replicates of known call
# types and buffers to 3k detections. Excludes uncertain KW calls
...
DCLDE_train= DCLDE_train[DCLDE_train$KW_certain %in% c(1, NA),]
...
# Sanity check
print(table(birdnet11$Labels))


# Save final dataset
birdnet11 = write_csv(birdnet11, 'DCLDE_train_birdnet11.csv')

library(ggplot2)

# Plot label distribution by dataset
label_dataset_counts <- birdnet11 %>%
