...
annotations = pd.read_csv("C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\\BirdnetOrganized\\Birdnet09\\Code\\DCLDE_train_birdnet09_balanced_2000perclass.csv")
...
for idx, row in annotations.iloc[0:].iterrows():
    ...
    base_output_dir = "C:\\TempData\\birdnet_09\\"
