...
annotations = pd.read_csv("C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\\BirdnetOrganized\\Birdnet01\\Code\\DCLDE_train_birdnet01.csv")
...
for idx, row in annotations.iloc[0:].iterrows():
    ...
    base_output_dir = "C:\\TempData\\birdnet_01\\"
