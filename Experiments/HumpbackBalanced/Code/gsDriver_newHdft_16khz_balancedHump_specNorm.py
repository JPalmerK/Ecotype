...
# Nov 29, 2024
This did not work at all. I think the normalizing the spectrograms is not 
actually useful. Instead trying to add batch normalization back into the model
Testing the 8khz data and then maybe re-create the H5 with 16khz data
...
hdf5_file_path_traintest = '/home/kpalmer/MnBalanced_16khz_PCEN_RTW_normSpec.h5'
df5_file_path_val='/home/kpalmer/Malahat_Balanced_melSpec_16khz_PCEN_RTW_normSpec.h5'
...
trainLoader = Eco.BatchLoader2(hdf5_file_path_traintest, 
                               trainTest='train', batch_size=256, n_classes=num_classes, 
                               minFreq=0)

testLoader = Eco.BatchLoader2(hdf5_file_path_traintest, 
                              trainTest='test', batch_size=256, n_classes=num_classes, 
                              minFreq=0)

valLoader = Eco.BatchLoader2(df5_file_path_val, 
                             trainTest='train', batch_size=500, n_classes=num_classes, 
                             minFreq=0)
...
model_save_path = 'MnBalanced_16khz_Resnet18_RTO_normSpec.keras'
save_history_to_pickle(history, 'training_history_MnBalanced_16khz_Resnet18_RTO_normSpec.pkl')
...
np.savetxt("MnBalanced_16khz_Resnet18_RTO_normSpecConfMat.csv", confResults, delimiter=",")
