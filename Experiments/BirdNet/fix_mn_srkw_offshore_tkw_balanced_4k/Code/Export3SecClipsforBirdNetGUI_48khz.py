...
annotations = pd.read_csv("C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\\BirdNet\\Bckrnd_mn_srkw_tkw_offshore_TKW_balanced_4k\\Data\\Better_BackgroundSpread.csv")
...
for idx, row in annotations.iloc[0:].iterrows():
    ...
    base_output_dir = "C:\\TempData\\BirdNet5class_balacedTKWCalls_fixed\\"
