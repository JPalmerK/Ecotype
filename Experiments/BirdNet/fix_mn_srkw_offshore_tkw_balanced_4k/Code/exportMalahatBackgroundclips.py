...
annotations = pd.read_csv('C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\\BirdNet\\fix_mn_srkw_offshore_tkw_balanced_4k\\Data\\MalahatBackground.csv')
...
for idx, row in annotations.iloc[0:].iterrows():
    ...
    utc = row['UTC']
    speciesFolder = row['ClassSpecies']
    SoundFilee = row['Soundfile']
    
    # Define the base output directory and the species-specific folder
    base_output_dir = "C:\\TempData\\AllData_forBirdnet\\MalahatValidation\\\Background\\"
