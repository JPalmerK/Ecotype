...
annotations = pd.read_csv("C:\\Users\\kaity\\Documents\\GitHub\\Ecotype\\Experiments\\BirdNet\\Backgrd_mn_srkw_tkw_okw_6k\\Data\\BirdNetAnnotations.csv")
...
for idx, row in annotations.iloc[0:].iterrows():
    ...
    base_output_dir = "C:\\TempData\\Birdnet6kclips_RTOMN_BG\\"
