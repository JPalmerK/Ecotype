...
trainLoc ="C:/Users/kaity/Documents/GitHub/Ecotype/Experiments\\BirdNet\\Birdnet7Class_ONC_Larger\\Data\\SmallerDataONC_fix_Train_4k.csv"
testLoc = "C:/Users/kaity/Documents/GitHub/Ecotype/Experiments\\BirdNet\\Birdnet7Class_ONC_Larger\\Data\\SmallerDataONC_fix_Test_4k.csv"
...
annotations.Lables.value_counts()
...
annotations.rename(columns={'Lables':'Labels'}, inplace=True)
...
for idx, row in annotations.iloc[0:].iterrows():
    ...
    base_output_dir = "C:\\TempData\\Birdnet4k\\"
