...
# This is the same as NorthwestAtlantic_ECOTYPEdATA_RTO_hop25_balancedHumps.py
# with the exception of normalizing the spectrograms between 1 and 0 and using
# 16khz sample rate. I've als included all of the parameters from ecotype 
# defs because those have changed throughout the building process. Oops.
...
annot_test = pd.read_csv("C:/Users/kaity/Documents/GitHub/Ecotype/Experiments\\HumpbackBalanced\\Data\\RTO_test_HumpBalanced.csv")
...
h5_fileTrainTest = 'C:/Users/kaity/Documents/GitHub/Ecotype/Experiments/HumpbackBalanced\\Data\\MnBalanced_16khz_PCEN_RTW_normSpec.h5'
Eco.create_hdf5_dataset(annotations=AllAnno, hdf5_filename= h5_fileTrainTest, 
                        parms=AudioParms)

h5_file_validation = 'C:/Users/kaity/Documents/GitHub/Ecotype/HDF5 Files\\Malahat_Balanced_melSpec_16khz_PCEN_RTW_normSpec.h5'
...
trainLoader =  Eco.BatchLoader2(h5_fileTrainTest, 
                            trainTest = 'train', batch_size=256,  n_classes=6,  
                            minFreq=0)

testLoader =  Eco.BatchLoader2(h5_fileTrainTest, 
                            trainTest = 'test', batch_size=256,  n_classes=6,  
                            minFreq=0)
...
history = Eco.train_model_history(model, trainLoader, testLoader, epochs=20)

model.save('C:/Users/kaity/Documents/GitHub/Ecotype/ModelsEcotype/Experiments/HumpbackBalanced/MnBalanced_16khz_Resnet18_RTO_normSpec.keras')
#%%


label_dict = dict(zip(AllAnno['label'], AllAnno['Labels']))
h5_file_validation1 = 'C:/Users/kaity/Documents/GitHub/Ecotype/Experiments\\HumpbackBalanced\\Malahat_Balanced_melSpec_8khz_PCEN_RTW.h5'

model1 = load_model('C:/Users/kaity/Documents/GitHub/Ecotype/ModelsEcotype/Experiments/HumpbackBalanced/MnBalanced_16khz_Resnet18_RTO_normSpec.keras')
...
processor = Eco.AudioProcessor4(folder_path=folder_path, 
                                ...
                                selection_table_name="detections_Malahat_20241126.txt")
