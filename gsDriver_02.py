...
model_save_path = 'resnet18_PECN_melSpec_300Hz.keras'
...
np.savetxt("MalahatConfMat_wider_model2_300hz.csv", confResults, delimiter=",")
...
upload_blob(bucket_name, "MalahatConfMat_wider_model2_300hz.csv", 'output/MalahatConfMat_wider_model2_300hz.csv')
